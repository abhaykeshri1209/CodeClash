        ...
        <div className="rounded-2xl border border-white/10 bg-white/[0.04] backdrop-blur-xl shadow-[0_8px_40px_rgba(0,0,0,0.5)] p-8">
          ...
          <div className="flex flex-col items-center mb-8">
            ...
            <p className="mt-2 text-xs font-mono text-slate-500">
              create_account() — join and start solving
            </p>
          </div>
                  ...
                  {showPassword ? (
                    ...
                    >
                      ...
                      <path
                        ...
                        strokeLinejoin="round"
                        strokeWidth={2}
                        d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 3.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"
                      />
                    </svg>
                  )}
                </button>
...
// jo bhi data hoga wah cookies me store hoga so attack se bach pae
//kyuki localstrogate me attack ho skta hai js script se
